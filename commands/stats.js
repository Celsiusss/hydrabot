...
exports.run = (bot, msg, params) => {
	...
	msg.channel.sendMessage(`Hydra is aware of ${bot.users.size} users, in ${bot.channels.size} channels in ${count} servers with currently ${streams} playing right now!`)
